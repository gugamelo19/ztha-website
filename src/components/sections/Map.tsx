...
export default function MapaCobertura() {
  return (
    <ComposableMap
      ...
      projectionConfig={{ center: [-56, -16], scale: 820 }}
      width={960}
      height={680}
    ...
    >
      ...
      <Marker coordinates={SEDE}>
        ...
        <rect x={-52} y={-22} width={88} height={20} rx={4} fill="#fff" stroke="#C8EDE4" strokeWidth={1}/>
        <text x={-8} y={-7} textAnchor="middle" fontSize={10} fontWeight={700} fill="#2B8970" fontFamily="sans-serif">
          Serrinha/BA — Sede
        </text>
      </Marker>
    </ComposableMap>
